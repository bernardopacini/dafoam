...
cdef extern from "DASolvers.H" namespace "Foam":
    cppclass DASolvers:
        ...
        void calcFvSource(char *, PetscVec, PetscVec, PetscVec, PetscVec, double, double, PetscVec)
        void calcdFvSourcedInputsTPsiAD(char *, char *, PetscVec, PetscVec, PetscVec, PetscVec, double, double, PetscVec, PetscVec)
...
cdef class pyDASolvers:
    ...
    def calcFvSource(self, propName, Vec aForce, Vec tForce, Vec rDist, Vec center, rInner, rOuter, Vec fvSource):
        self._thisptr.calcFvSource(propName, aForce.vec, tForce.vec, rDist.vec, center.vec, rInner, rOuter, fvSource.vec)
    
    def calcdFvSourcedInputsTPsiAD(self, propName, mode, Vec aForce, Vec tForce, Vec rDist, Vec center, rInner, rOuter, Vec psi, Vec dFvSource):
        self._thisptr.calcdFvSourcedInputsTPsiAD(propName, mode, aForce.vec, tForce.vec, rDist.vec, center.vec, rInner, rOuter, psi.vec, dFvSource.vec)
